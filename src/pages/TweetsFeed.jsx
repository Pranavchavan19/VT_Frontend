...
const TweetsFeed = () => {
    ...
    useEffect(() => {
        const fetchTweets = async () => {
            ...
            setTweets(data.data);  // Set tweets data in state
        };
        ...
        <div className="text-white w-full flex flex-col gap-3">
            {tweets.map((tweet) => (
                ...
                >
                    ...
                    <div className="w-full flex flex-col gap-1 relative">
                        <div className="flex items-center gap-2">
                            <h2 className="text-xs">{tweet.ownerDetails.username || "Anonymous"}</h2>
                        </div>
                        ...
                        {editState.editingTweetId === tweet._id ? (
                            <div className="flex flex-col gap-3">
                                ...
                                <button
                                    ...
                                    onClick={() => handleEditTweet(tweet._id, editState.editedContent)}
                                >
                                    Save
                                </button>
                                <button
