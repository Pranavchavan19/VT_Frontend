...
import { HiOutlineDotsVertical } from "../components/icons";
import { getAllTweets, deleteTweet, editTweet } from "../Store/Slices/tweetSlice";
import TweetAndComment from "../components/TweetAndComment"; // Import the TweetAndComment component
...
function TweetsFeed({
    ...
    return (
        <div className="text-white w-full flex flex-col gap-3">
            ...
            <TweetAndComment tweet={true} /> {/* Pass `tweet` prop to specify the behavior */}
