...
function SignUp() {
    ...
    return (
        <div className="w-full h-screen bg-black text-white p-3 flex justify-center items-start sm:mt-8">
            <div className="flex flex-col space-y-2 justify-center items-center border border-slate-600 p-3">
                ...
                >
                    <div className="w-full relative h-28 bg-[#222222]">
                        <div className="w-full h-full">
                            <GetImagePreview
                                ...
                                cameraIcon
                            />
                            <div className="text-sm absolute right-2 bottom-2 hover:text-purple-500 cursor-default font-bold ">
                                Cover Image
                            </div>
                        </div>
                    ...
                    {errors.coverImage && (
                        <div className="text-red-500 font-bold text-lg capitalize">
